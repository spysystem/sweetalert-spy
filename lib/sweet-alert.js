...
;(function(window, document, undefined) {
  ...
  function modalDependant() {
    ...
    var onButtonEvent = function(event) {
      ...
      var target = e.target || e.srcElement,
          ...
          targetedCancel     = (target.className.indexOf("cancel") !== -1),
      ...
      switch (e.type) {
        ...
        case ("mousedown"):
          ...
          if (targetedCancel) {
            target.style.backgroundColor = colorLuminance(params.cancelButtonColor, -0.14);
          }
          break;
        case ("mouseup"):
          if (targetedConfirm) {
    ...
    function handleKeyDown(event) {
      ...
      if (keyCode === 9) {
        ...
        setFocusStyle($targetElement, params.cancelButtonColor); // TODO

      } else {
        if (keyCode === 13 || keyCode === 32) {
            if (btnIndex === -1 && params.allowEnterConfirm) {
  ...
  function setParameters(params) {
	...
	if (params.floatButton) {
		$confirmBtn.style.float	= 'right';
		$cancelBtn.style.float	= 'left';
	} else {
		$confirmBtn.style.float	= '';
		$cancelBtn.style.float	= '';
	}
